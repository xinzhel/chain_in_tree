# [Deprecated] We recommend using [LiTS](https://github.com/xinzhel/lits-llm) to reproduce CiT. LiTS is a general-purpose tree search framework. An updated version, along with a clear guide for applying it to CiT, will be released on April 26, 2026.
